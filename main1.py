...
# area1_pointA = (150,225)
# area1_pointB = (400,200)
# area1_pointC = (150,250)
# area1_pointD = (400,225)

area1_pointA = (210,350)
area1_pointB = (865,350)
area1_pointC = (165,365)
area1_pointD = (920,365)

area2_pointA = (210,250)
area2_pointB = (880,250)
area2_pointC = (165,265)
area2_pointD = (940,265)
...
def detect(save_img=False):
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            cv2.line(im0, area2_pointC, area2_pointD, (0, 255, 255), 2)
            ...
            cv2.putText(im0, 'Person Counting = '+str(counting), org, font, fontScale, color, thickness, cv2.LINE_AA)
